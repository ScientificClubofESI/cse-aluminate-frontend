...
const Hero = () => {
  return (
    <section className='px-[5%] mt-[200px] lg:px-[8%] flex flex-col lg:flex-row items-center justify-center lg:justify-between space-y-8 lg:grid lg:grid-cols-2 lg:my-[5%]'>

      <p className='text-4xl lg:text-5xl mt-10 font-extrabold text-center lg:text-left lg:justify-start'>Connecting Alumni Uniting Dreams</p>
      ...
      <div className='relative bg-white w-full rounded-[72px] border border-Secondary-50 flex items-center justify-between lg:hidden'>
        ...
        <div className=' z-50 lg:px-[8px] lg:py-[8px]'>
          <button className='bg-Secondary-500 rounded-[24px] py-2 lg:py-3 px-4 lg:px-6'>
            <div className='z-50 text-xs lg:text-xl font-normal text-white leading-loose tracking-tight'>Find Alumni</div>
          </button>
        </div>

        <input placeholder='search' className='z-0 absolute py-[12px] px-20 outline-none bg-white w-full rounded-[72px] border border-Secondary-50 flex items-center justify-between lg:hidden' />
      </div>
